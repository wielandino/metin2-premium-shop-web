...
import { MOCK_ARMORY_EFFECT_FLAT_DAMAGE_RESISTANCE_EFFECT, MOCK_ARMORY_EFFECT_FLAT_DAMAGE, MOCK_ARMORY_EFFECT_ELEMENT_DAMAGE_FIRE, MOCK_ARMORY_EFFECT_ELEMENT_RESISTENCE_LIGHT, MOCK_ARMORY_EFFECT_FLAT_RESISTANCE_EFFECT } from "./ArmoryEffectMocking";
